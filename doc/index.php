...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td><a href="http://<?php echo $domain; ?>"><img src="http://<?php echo $domain; ?>/themes/inria/images/logo.png" border="0" alt="gforge INRIA" width="198" height="52" /></a></td>
		<td style="text-align: right; vertical-align: top;"><a href="http://<?php echo $domain; ?>/projects/<?php echo $group_name; ?>"><img
...
<br>
<br>
<center><table cellspacing="0" cellpadding="1" width="75%" border="0" bgcolor="#f5c5c5">
<tr><td>
<center>
   Most informations (documentation, FAQ, articles, ...) on the SimGrid project can be found 
  <b><a href='doc/'>here</a></b>.
</center>
</td></tr>
</table>
</center>
