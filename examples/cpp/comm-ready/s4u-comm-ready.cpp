...
int main(int argc, char* argv[])
{
  ...
  e.host_by_name("Tremblay")->add_actor("peer", peer, 0, 2, 5e7, 3);
  e.host_by_name("Ruby")->add_actor("peer", peer, 1, 6, 2.5e5, 3);
  e.host_by_name("Perl")->add_actor("peer", peer, 2, 0, 5e7, 3);
