...
OBJFILES = ..\..\win32_testsuite\borland\builder6\simulation\obj\maxmin_bench.obj \
...
WARNINGS= -w-tai -w-sus -w-rvl -w-rch -w-pia -w-pch -w-par -w-csu -w-ccc -w-aus
