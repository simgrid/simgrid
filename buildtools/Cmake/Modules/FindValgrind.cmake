...
if(VALGRIND_EXE)
  ...
  if(NEW_VALGRIND_VERSION)
    ...
    set(MEMORYCHECK_COMMAND_OPTIONS "--trace-children=yes --trace-children-skip=/usr/bin/*,/bin/* --leak-check=full --show-reachable=yes --track-origins=no --read-var-info=no --suppressions=${CMAKE_HOME_DIRECTORY}/tools/simgrid.supp")
