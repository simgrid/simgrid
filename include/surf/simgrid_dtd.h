...
typedef int AT_surfxml_cluster_torus___dimensions;
#define AU_surfxml_cluster_torus___dimensions NULL
...
XBT_PUBLIC_DATA(AT_surfxml_cluster_torus___dimensions) AX_surfxml_cluster_torus___dimensions;
#define A_surfxml_cluster_torus___dimensions (surfxml_bufferstack + AX_surfxml_cluster_torus___dimensions)
XBT_PUBLIC_DATA(short int) surfxml_cluster_torus___dimensions_isset;
