...
directories_new(void)
{
	...
	directories->items = xbt_dynar_new(sizeof(directory_t), (void_f_pvoid_t)directory_free);
...
int
directories_load(directories_t directories, fstreams_t fstreams, xbt_dynar_t suffixes)
{
