...
option(enable_static_library        "Also build SimGrid as a static library" off)
...
macro(declare_tristate VAR DOC)
  set(${VAR} "AUTO" CACHE STRING "${DOC} (AUTO, ON, OFF)")
  set_property(CACHE ${VAR} PROPERTY STRINGS AUTO ON OFF)
  set(_valid AUTO ON OFF)
  if(NOT ${VAR} IN_LIST _valid)
      message(FATAL_ERROR "${VAR} must be either AUTO, ON or OFF. ${${VAR}} is not a valid value.")
  endif()
endmacro()

option(enable_sthread "Whether the pthread intercepter is built" ${default_enable_sthread})
declare_tristate(enable_smemory "Whether the memory intercepter is built")
