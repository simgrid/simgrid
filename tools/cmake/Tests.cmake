...
if((NOT enable_memcheck) AND (NOT enable_address_sanitizer) AND (NOT enable_undefined_sanitizer) AND (NOT enable_thread_sanitizer))
  ...
  ADD_TEST(tuto-msg-0 sh -xc "${tuto-make} clean masterworker      && ${tuto-bin-path}/masterworker      ${tuto-platform-file} ${tuto-src-path}/deployment0.xml")
  ADD_TEST(tuto-msg-1 sh -xc "${tuto-make} clean masterworker-sol1 && ${tuto-bin-path}/masterworker-sol1 ${tuto-platform-file} ${tuto-src-path}/deployment1.xml")
  ADD_TEST(tuto-msg-2 sh -xc "${tuto-make} clean masterworker-sol2 && ${tuto-bin-path}/masterworker-sol2 ${tuto-platform-file} ${tuto-src-path}/deployment2.xml")
  ADD_TEST(tuto-msg-3 sh -xc "${tuto-make} clean masterworker-sol3 && ${tuto-bin-path}/masterworker-sol3 ${tuto-platform-file} ${tuto-src-path}/deployment3.xml")
  ADD_TEST(tuto-msg-4 sh -xc "${tuto-make} clean masterworker-sol4 && ${tuto-bin-path}/masterworker-sol4 ${tuto-platform-file} ${tuto-src-path}/deployment3.xml")
