...
int PMPI_Get( void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank,
  ...
  if (win == MPI_WIN_NULL) {
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Get", target_rank,
...
int PMPI_Rget( void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank,
  ...
  if (win == MPI_WIN_NULL) {
    ...
    *request = MPI_REQUEST_NULL;
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Rget", target_rank,
                                                       origin_datatype->is_replayable() ? origin_count : origin_count * origin_datatype->size(),
                                                       encode_datatype(origin_datatype)));
...
int PMPI_Put( void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank,
  ...
  if (win == MPI_WIN_NULL) {
    ...
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Put", target_rank,
                                                       origin_datatype->is_replayable() ? origin_count : origin_count * origin_datatype->size(),
                                                       encode_datatype(origin_datatype)));
...
int PMPI_Accumulate( void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank,
  ...
  if (win == MPI_WIN_NULL) {
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Accumulate", target_rank,
                                                       origin_datatype->is_replayable() ? origin_count : origin_count * origin_datatype->size(),
                                                       encode_datatype(origin_datatype)));
...
int PMPI_Raccumulate( void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank,
  ...
  if (win == MPI_WIN_NULL) {
    ...
    *request = MPI_REQUEST_NULL;
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Raccumulate", target_rank,
                                                       origin_datatype->is_replayable() ? origin_count : origin_count * origin_datatype->size(),
                                                       encode_datatype(origin_datatype)));
...
MPI_Datatype target_datatype, MPI_Op op, MPI_Win win){
  ...
  if (win == MPI_WIN_NULL) {
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Get_accumulate", target_rank,
...
MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request* request){
  ...
  if (win == MPI_WIN_NULL) {
    ...
    *request = MPI_REQUEST_NULL;
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Rget_accumulate", target_rank,
                                                       target_datatype->is_replayable() ? target_count : target_count * target_datatype->size(),
                                                       encode_datatype(target_datatype)));
                          ...
                          int target_rank, MPI_Aint target_disp, MPI_Win win)
{
  ...
  if (win == MPI_WIN_NULL) {
    ...
    MPI_Group group;
    win->get_group(&group);
    TRACE_smpi_comm_in(my_proc_id, __FUNCTION__, new simgrid::instr::Pt2PtTIData("Compare_and_swap", target_rank,
