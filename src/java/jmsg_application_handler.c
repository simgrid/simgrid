...
japplication_handler_on_start_document(void)
{
	...
	JNIEnv * env = get_current_thread_env();
  	...
  	jmethodID id = jxbt_get_static_smethod(env,"simgrid/msg/ApplicationHandler","onStartDocument", "()V") ;
...
japplication_handler_on_end_document(void)
{
	...
	JNIEnv * env = get_current_thread_env();
  	...
  	jmethodID id = jxbt_get_static_smethod(env,"simgrid/msg/ApplicationHandler","onEndDocument", "()V") ;
...
japplication_handler_on_begin_process(void)
{
	...
	JNIEnv * env = get_current_thread_env();
  	...
  	jmethodID id = jxbt_get_static_smethod(env,"simgrid/msg/ApplicationHandler","onBeginProcess", "(Ljava/lang/String;Ljava/lang/String;)V") ;
	
	if(!id || !(cls = jxbt_get_class(env , "simgrid/msg/ApplicationHandler")))
		return;
		
	jhostName = (jstring)(*env)->NewStringUTF(env, A_surfxml_process_host);
	jfunction = (jstring)(*env)->NewStringUTF(env, A_surfxml_process_function);
...
japplication_handler_on_process_arg(void)
{
	...
	JNIEnv * env = get_current_thread_env();
  	...
  	jmethodID id = jxbt_get_static_smethod(env,"simgrid/msg/ApplicationHandler","onProcessArg", "(Ljava/lang/String;)V") ;
...
japplication_handler_on_property(void)
{
	...
	JNIEnv * env = get_current_thread_env();
  	...
  	jmethodID id = jxbt_get_static_smethod(env,"simgrid/msg/ApplicationHandler","onProperty", "(Ljava/lang/String;Ljava/lang/String;)V") ;
...
japplication_handler_on_end_process(void)
{
	JNIEnv * env = get_current_thread_env();
	jclass cls;
  	jmethodID id = jxbt_get_static_smethod(env,"simgrid/msg/ApplicationHandler","onEndProcess", "()V") ;
