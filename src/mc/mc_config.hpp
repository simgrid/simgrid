...
extern XBT_PRIVATE simgrid::config::Flag<bool> _sg_mc_autoreplay;
...
extern XBT_PRIVATE simgrid::config::Flag<int> _sg_mc_eta_steps;
...
extern XBT_PUBLIC std::vector<uintptr_t>& get_mc_watch_addresses();
