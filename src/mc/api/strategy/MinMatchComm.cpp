...
void MinMatchComm::copy_from(const StratLocalInfo* strategy)
{
...
std::pair<aid_t, int> MinMatchComm::best_transition(bool must_be_todo) const
{
...
void MinMatchComm::consider_best_among_set(std::unordered_set<aid_t> E)
{
...
void MinMatchComm::execute_next(aid_t aid, RemoteApp& app)
{
