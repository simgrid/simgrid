...
void TRACE_msg_process_change_host(msg_process_t process, msg_host_t new_host)
{
  if (TRACE_msg_process_is_enabled()){
    ...
    type_t type = s_type::PJ_type_get ("MSG_PROCESS_LINK", PJ_type_get_root());
    ...
    type = s_type::PJ_type_get ("MSG_PROCESS_LINK", PJ_type_get_root());
...
void TRACE_msg_process_suspend(msg_process_t process)
{
  if (TRACE_msg_process_is_enabled()){
    ...
    type_t type = s_type::PJ_type_get ("MSG_PROCESS_STATE", process_container->type);
