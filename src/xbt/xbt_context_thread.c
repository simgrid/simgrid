...
xbt_ctx_thread_factory_create_context(const char* name, xbt_main_func_t code, void_f_pvoid_t startup_func, void* startup_arg, void_f_pvoid_t cleanup_func, void* cleanup_arg, int argc, char** argv);
...
static int
xbt_ctx_thread_factory_finalize(xbt_context_factory_t* factory);

static void 
xbt_ctx_thread_free(xbt_context_t context);

static void 
xbt_ctx_thread_kill(xbt_context_t context);

static void 
xbt_ctx_thread_schedule(xbt_context_t context);

static void 
xbt_ctx_thread_yield(void);

static void 
xbt_ctx_thread_start(xbt_context_t context);

static void 
xbt_ctx_thread_stop(int exit_code);

static void 
xbt_ctx_thread_swap(xbt_context_t context);
...
static void
xbt_ctx_thread_suspend(xbt_context_t context);

static void
xbt_ctx_thread_resume(xbt_context_t context);
...
xbt_ctx_thread_start(xbt_context_t context)
{
	...
	ctx_thread->thread = xbt_os_thread_create(ctx_thread->name,xbt_ctx_thread_wrapper,ctx_thread);
