...
public:
  ...
  std::unique_ptr<mc::smemory::MemoryAccessTrace> memory_accesses_trace_;
...
public:
  ...
  simgrid::mc::smemory::MemoryAccessTrace* get_memory_trace() { return memory_accesses_trace_.get(); }
